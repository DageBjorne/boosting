...
def create_train_test_split(test_size=0.25,
    ...
    predictor_columns = [
        ...
        'zq95', 'pzabovezmean', 'pzabove2', 'zpcum1', 'zpcum2', 'zpcum3',
        'zpcum4', 'zpcum5', 'zpcum6', 'zpcum7', 'zpcum8', 'zpcum9'
    ]

    target_column = 'D_AVERAGE'

    data_sweden = pd.read_csv('Image_data/merged_data_permanent_cleaned.csv',
                              index_col=[0])
                                ...
                                for decay_factor in decay_factor_list:
                                    for alpha_0 in alpha_0_list:
                                        ...
                                        df.loc[len(df)] = [
                                            ...
                                            len(a_train),
                                            len(x_test), v1, target_tree_size,
